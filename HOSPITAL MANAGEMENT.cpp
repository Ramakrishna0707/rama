...
{	
	...
	switch (id)
	{
		...
		case 4:
		{
			cout<<"NAME - DR. ANJALI SHARMA"<<endl;
			cout<<"SEX - FEMALE"<<endl;
...
void bill()
{
	...
	//Appointment Cost
	if( strcmp( add.specialist,"CARDIOLOGIST" )==0)
	cost+=2500;  
